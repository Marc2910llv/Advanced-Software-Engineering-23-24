...
def printStory(survivors, legion, defendants, capitalAttacked):
    print("The Roman Empire attacked with a legion having "+str(legion)+" men.")
    print("During the march toward the capital the legion battle againts "+str(defendants)+" men.")
    if capitalAttacked == 0:
        if survivors > 0:
            print("The legion lost the battle and only "+str(survivors)+" came back to Rome.")
        else:
            print("The legion lost the battle and nobody came back to Rome alive.")
        print("This day was disastrous for the Empire.")
        return {}
    print("The legion won the battle and attaccked the capital.")
    print("In the end...")
    time.sleep(5)
    if(survivors > 0):
        print("... the capital was conquered by the Roman Empire!")
        print("Glory to the "+str(survivors)+" survivors! Glory to the Empire!")  
        return {}
    print("The legion lost during the capital attack. This day was disastrous for the Empire.")